...
public class RoomController {
    ...
    public String test2(ModelMap mm) throws IOException {

        Room room = roomRepository.getRoomByRoomId(1);
        room.getRoomId();
        mm.put("room", room);
        room.getRoomTypeByTypeId().getHostelByHostelId().getOwnerHostelId();
        return "test2";
    }
//
