...
import com.example.hostelmanagement.utils.Momo.models.PaymentRequest;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, com.example.hostelmanagement.utils.Momo.enums.RequestType requestType) throws Exception {
        try {
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
                                                           String returnUrl, String notifyUrl, String extraData, com.example.hostelmanagement.utils.Momo.enums.RequestType requestType) {
