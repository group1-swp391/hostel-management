...
ALTER TABLE tbl_roomCharge
add price float
alter table tbl_roomCharge
    alter column invoiceID int null
go
alter table tbl_Contracts
    add depositPaymentStatus bit
go
alter table tbl_Users
    alter column username null
go
...
INSERT INTO tbl_Users(userName,password,fullName,dateOfBirth,gender,phone,email,documentID,roleID,userStatus) values ('thao','thao123','Phuong Thao','2009-01-01',1,'0987563269','thao2009@gmail.com','123000001',3,1)
